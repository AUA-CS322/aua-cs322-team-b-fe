...
export const makeRequestAction = (name, options) =>
  new GenerateAction(name, options);
...
class GenerateAction {
  constructor(name, options) {
    ...
    this.options.advanced =
      this.options.advanced == null ? true : this.options.advanced;
